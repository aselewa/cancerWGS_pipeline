...
--wait-for-files /project2/xinhe/alan/Cancer/wgs_pipeline/.snakemake/tmp.k44mz0tc /project2/xinhe/alan/Cancer/testing_wgs/aligned/DO30_normal.bam --latency-wait 5 \
 --attempt 1 --force-use-threads \
--wrapper-prefix https://bitbucket.org/snakemake/snakemake-wrappers/raw/ \
 --configfile /project2/xinhe/alan/Cancer/wgs_pipeline/configfile.yaml -p --nocolor \
--notemp --no-hooks --nolock --mode 2  --allowed-rules remove_duplicates  && touch "/project2/xinhe/alan/Cancer/wgs_pipeline/.snakemake/tmp.k44mz0tc/2.jobfinished" || (touch "/project2/xinhe/alan/Cancer/wgs_pipeline/.snakemake/tmp.k44mz0tc/2.jobfailed"; exit 1)
